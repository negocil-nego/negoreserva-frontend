    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        {#if org}
          <div class="border border-border bg-card p-5 space-y-4">
            <div class="flex items-center gap-3">
              ...
              {:else}
                <div
                  class="w-12 h-12 bg-muted flex items-center justify-center text-muted-foreground text-lg font-bold"
                >
              ...
              {#each data.prices as price (price.uuid)}
                ...
                >
                  ...
                  <span class="font-semibold">
                    {price.value.toLocaleString("pt-AO", {
                      style: "currency",
                      currency: "AOA",
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        {#if data.tags?.length > 0}
          <div class="border border-border bg-card p-5 space-y-3">
            <h3
              class="text-sm font-semibold uppercase tracking-widest text-muted-foreground"
            >
              Informações
