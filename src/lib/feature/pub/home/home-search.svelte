...
<div class="container relative mt-10">
  <div
    class="absolute -top-5 left-0 right-0 mx-auto w-full z-10 shadow border bg-panel dark:border-gray-800 m-auto"
  >
    <div
    ...
    >
      ...
      <div class="flex gap-1">
        ...
        <Button
          ...
          class="flex justify-center items-center cursor-pointer bg-brand hover:text-white"
          variant="outline"
        >
          <HugeiconsIcon
            icon={Search01Icon}
